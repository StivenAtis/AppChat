...
import nombreunicoanivelmundial_co.udenar.edu.mychatapp.databinding.FragmentChatBinding
import nombreunicoanivelmundial_co.udenar.edu.mychatapp.databinding.ToolbarAddonChatBinding
import nombreunicoanivelmundial_co.udenar.edu.mychatapp.R

/* En esta clase se implementa la lógica relacionada con la visualización y gestión de mensajes en
el chat. */
class ChatFragment : Fragment() {
    ...
    /*Se utiliza un ViewModel llamado ChatViewModel para manejar la lógica de presentación */
    ...
    override fun onCreateView(
        ...
        val messagesRecyclerView = viewDataBinding.root.findViewById<RecyclerView>(R.id.messagesRecyclerView)


        /* configura una barra de herramientas personalizada */
    ...
    private fun setupListAdapter() {
        ...
        val recyclerView = viewDataBinding.messagesRecyclerView
