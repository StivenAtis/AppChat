...
/* Observa la conexión del dispositivo a la base de datos y actualiza el estado en línea del usuario. */
class FirebaseReferenceConnectedObserver {
    ...
    /* Inicia la observación de la conexión y el estado en línea del usuario. */
    fun start(userID: String) {
        ...
        this.dbRef = FirebaseDataSource.dbInstance.getReference(".info/connected")
    ...
    /* Detiene la observación y actualiza el estado en línea del usuario a "false" al desconectar. */
    fun clear() {
...
/* Observa cambios en un valor específico en la base de datos. */
class FirebaseReferenceValueObserver {
    private var valueEventListener: ValueEventListener? = null
    private var dbRef: DatabaseReference? = null

    /* Inicia la observación de un valor específico. */
...
/* Observa cambios en los hijos de un nodo específico en la base de datos. */
class FirebaseReferenceChildObserver {
    private var valueEventListener: ChildEventListener? = null
    private var dbRef: DatabaseReference? = null
    private var isObserving: Boolean = false

    /* Inicia la observación de los hijos de un nodo. */
    ...
    /* evuelve un booleano indicando si la observación está activa. */
    fun isObserving(): Boolean {
        return isObserving
    }
}

/* Proporciona métodos para realizar operaciones en la base de datos de Firebase, como
actualizaciones, eliminaciones y consultas. */

/* Métodos para actualizar, eliminar y cargar información de usuarios, amigos, chats, notificaciones, etc.
Métodos para adjuntar observadores de cambios en valores específicos.
Métodos para cargar información específica de la base de datos. */
